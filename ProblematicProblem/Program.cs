...
public class Program
{
        static void Main(string[] args)
        {
            ...
            bool seeList = Console.ReadLine() == "sure".ToLower() ? true : false;
            if (seeList)
            {
                ...
                bool addToList = Console.ReadLine() == "sure".ToLower() ? true : false;
                Console.WriteLine();
                while (addToList)
                {
            ...
            Console.Write($"Ah got it! {randomActivity}, your random activity is: {userName}! Is this ok or do you want to grab another activity? Keep/Redo: ");
                ...
                cont = Console.ReadLine() == "Redo".ToLower() ? true : false;
            }
        }
    }
}
